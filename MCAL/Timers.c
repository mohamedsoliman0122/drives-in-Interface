...
static void (*Fptr_OVF0_INT)(void) = NULLPTR;
static void (*Fptr_OC0_INT)(void) = NULLPTR;
/**************************************** Call Back Functions ************************************/
...
//we make it static to not be edited by any one in another files
//concept of setter and getter
static void (*Fptr_OVF1_INT)(void) = NULLPTR;
static void (*Fptr_OCA_INT)(void) = NULLPTR;
static void (*Fptr_OCB_INT)(void) = NULLPTR;
static void (*Fptr_ICU1_INT)(void) = NULLPTR;
/**************************************** Call Back Functions ************************************/
...
//we make it static to not be edited by any one in another files
//concept of setter and getter
static void (*Fptr_OVF2_INT)(void) = NULLPTR;
static void (*Fptr_OC2_INT)(void) = NULLPTR;
/**************************************** Call Back Functions ************************************/
